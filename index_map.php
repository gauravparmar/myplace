...
?>" method="post">
  ...
  <div id="services" class="page color-4">
    ...
    <div class="inner-page row"  style="padding:0 0;">
      <ul class="features list-inline">
        <li>
          ...
          <p>Easily search any place, product, thing, service, area or any combination of these through Glog's 3-way searching mechanism. Searching was not so easy before Glog.</p>
        </li>
         <li>
          <h3><i class="fa fa-list"></i> Advertisement</h3>
          <p>At Glog, we provide you the service to grow your business with our advertisement facility. Our advertisement solution is easy to understand and cheaper.</p>
        </li>
        <li>
          <h3><i class="fa fa-check"></i>Suggestion.</h3>
          <p>Want your shop, business, mall etc to be displayed under our search list. Just post us a suggestion and we shall display your place in Glog. Get global coverage for your place.</p>
        </li>
    ...
    <div class="row inner-page">
      ...
      <div class="col-md-6">
        ...
        <p class="lead"><strong>Glog</strong> is built to look great on every device. Custom menu for mobiles, tablets, desktop computers and laptops, to ensure the best user expierence.</p>
        <ul class="list-wide">
  ...
  <div id="suggest" class="page color-3">
    ...
    <div class="row inner-page contact"  style="padding:0 0;">
      <div class="col-md-12">
              ...
              if(isset($_POST['suggest_place_name'])||isset($_POST['suggest_for'])||isset($_POST['suggest_description'])||isset($_POST['suggest_address'])||isset($_POST['suggest_contact_number'])||isset($_POST['suggest_business_email'])||isset($_POST['suggest_url'])||isset($_POST['suggest_your_name'])||isset($_POST['suggest_your_email'])||isset($_POST['suggest_code']))
              {
                ...
                else
                {
                  if($_POST['suggest_code']==$generated_captcha)
                  {
                      ...
                      $query="INSERT INTO `temp_places` VALUES('','$suggest_for', '$suggester_name', '$suggest_description', '$suggest_address', '$suggest_contact_number', '$suggest_business_email', '$suggest_url','$suggest_your_name','$suggest_your_email','$current_time','$timestamp')";
                      $query_run=mysql_query($query);
        ...
        <form id="contact-form" action="index.php?#suggest" method="post">  
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                  ...
                  <input class="form-control" name="suggest_your_email" placeholder="Your Email ID" type="text">  
                  <div class="col-md-12">
                    <div class="col-md-4">
                      Enter This Code
                    </div>
                    ...
                    <div class="col-md-4">
                      <input name="suggest_code" style="padding-top:0px; margin-top:0px;" class="form-control" placeholder="Enter Code *" type="text">     
                    </div>
                  </div>  
    ...
    <div class="clients color-1">
      <div class="inner-page"  style="padding:0 0;">
        <h2 class="page-headline">Why to use Glog?</h2>
      </div>
  ...
  <div id="advertise" class="page color-3">
    ...
    <div class="row inner-page contact">
      <div class="col-md-12">
        <h3>  Promote your business on Glog.</h3>
        ...
        <form id="contact-form" action="index.php?#advertise" method="post">  
              <div class="col-md-6">
                  ...
                  <input class="form-control" name="ad_email" placeholder="Enter Your Email ID (eg : your@e-mail.com) *" type="text">
   ...
   <!-- Feedback form -->
    <div class="row inner-page contact">
      <div class="col-md-12">
        ...
        <form id="contact-form" action="index.php?#feedback" method="post">
            ...
            <div class="col-md-6">
                ...
                <br>
                <input name="feed_email" class="form-control" placeholder="Your Email ID" type="text">
                <br>
                <div class="col-md-12">
                  <div class="col-md-4">
                    Enter This Code
      ...
      <div>
            ...
            <h3><center>Previous Postings</center></h3>
  ...
  <div id="about_us" class="page color-4">
    ...
    <div class="row inner-page team">
      <div class="col-md-6">
          <h3>Glog's Journey</h3>
          <p class="lead">Glog is developed after finding huge place searching requirements in people.</p>
          <p>We have seen people searching places in a difficult manner. Before Glog, the major difficulty was there when you are searching from your phone or tablet. At Glog we provide a device responsive design making Glog to be easily browsed from any device.</p>
      </div>
      <div class="col-md-6 team2">  
        <img class="pull-left" src="img/gaurav.png" alt="Gaurav Parmar" style="width:230px;">
        <h4>Gaurav Parmar</h4>
        <p><b>Founder, Creator, Designer, Developer and Owner of Glog.</b><br>I am a professional web developer, freelancer, entrepreneur and artist.</p>
        <ul>
          <li><i class="fa fa-home"></i>  <a href="http://glog.com/gaurav">http://glog.com/gaurav</a>
          </li>
          <li><i class="fa fa-envelope-o"></i>  <a href="mailto:gaurav@glog.com">gaurav@glog.com</a>
          </li>
          <li class="social">
    ...
    <div class="row inner-page" style="padding-top:0; margin-top:0px;">
      <center><h2>Reach Us</h2></center>
          <div class="col-md-12">
            <center><img class="img-responsive" src="img/map.png"></center>
          </div>
    </div>
  ...
  <footer class="page color-5">
    <div class="inner-page row">
      <div class="col-md-6 social">
        <a href="http://twitter.com/glog"><i class="fa fa-twitter"></i></a>
        <a href="http://github.com/glog"><i class="fa fa-github-square"></i></a> 
        <a href="http://facebook.com/glog"><i class="fa fa-facebook-square"></i></a>
        <a href="http://plus.google.com/+glog"><i class="fa fa-google-plus-square"></i></a>
      </div>
      <div class="col-md-6 text-right copyright">
        Copyright © <a href="#" title="twitter bootstrap themes">Gaurav Parmar</a> | All rights reserved | <a href="#top" title="Got to top" class="scroll">To top <i class="fa fa-caret-up"></i></a>
      </div>
    </div>
  </footer>
