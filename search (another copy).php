                            ...
                            <?php
                                ...
                                {   
                                    ...
                                    else
                                    {
                                        ...
                                        if($page_start>0)
                                            echo'<input type="submit" value="Previous" name="previous" align="right" class="btn btn-primary"/>';
                                        if(($page_start+$no_of_suggestions_to_show)<$total_records_found)
                                            echo'<input type="submit" value="Next" name="next"  align="right" class="btn btn-primary"/>';  
                                        ...
                                        if($page_start>0)
                                            echo'<input type="submit" value="Previous" name="previous" align="right" class="btn btn-primary"/>';
                                        if(($page_start+$no_of_suggestions_to_show)<$total_records_found)
                                            echo'<input type="submit" value="Next" name="next"  align="right" class="btn btn-primary"/></form>';   
