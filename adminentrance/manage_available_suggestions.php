...
<table width="98%" cellspacing="10">  
    ...
    <tr>
        <td class="function_title">
        	Manage Available Suggestions
        </td>
    </tr>
    <tr >
    	<td>
        	<form  action="manage_available_suggestions.php?page_start=<?php 
				...
				<?php
					...
					{	
						...
						/**seaching algo start**/	
								...
								$query="SELECT * FROM `places` WHERE $where_name AND $where_for AND $where_area ORDER BY `TIMESTAMP`  LIMIT $page_start, $page_end";
						...
						else
						{
							...
							echo'	<tr>
										<td align="center">
											<font color="#666666" face="Trebuchet MS, Arial, Helvetica, sans-serif" style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspShowing '.($page_start+$no_of_suggestions_for_current_page).' out of '.$total_records_found.' result',$suffix,' found. </font>'; 
							if($page_start>0)
								...
								echo '<tr >
									<td  class="suggestion_text_box" style="margin-top:15 0 0 0">
										<table cellpadding="1" cellspacing="0" border="0" width="100%" class="suggestion_text">
											<tr valign="top">
												<td colspan="2" >
												<a href="manage_available_suggestions.php?id='.$place_id.'" style="text-decoration:none;" class="place_names">'.$name.'</a>&nbsp;<strong>Added on : </strong>'.$date_and_time.'
												</td>
												
												<td colspan=2 align="right" ><a href="manage_available_suggestions.php?id='.$place_id.'" class="full_details" font-size:15px;"><font class="full_details">Full details..</font></a>
												</td>
												<td width="50px">
													<input type="button" value="Edit" class="edit_button" onCLick="window.location=\'available_suggestion_edit.php?id='.$place_id.'\'">
												</td>
												<td  width="50px">
													<input type="button" value="Delete" class="delete_button" onCLick="window.location=\'available_suggestion_delete.php?id='.$place_id.'\'">
												</td>
											</tr>
										</table>
									</td>
								  ...
								  <tr>
									<td  class="detailed_text_box" style="margin-top:10px;">
										<table cellpadding="1" cellspacing="0" border="0" width="100%" class="suggestion_detail_text" >
											<tr valign="top">
											  <td colspan="2" >Added on : '.$date_and_time.'</td>
											</tr>
											<tr valign="top" >
												...
												<table width="100%" border="0">
													<tr  height="52px">
														<td  align="left" style="padding-top:5px; text-shadow:0px 0px 2px rgba(0,0,0,1);" valign="top" >
															<font color="#FFF" face="Verdana, Geneva, sans-serif" style="background-color:#70B000; border-radius:5px; padding:2 5 2 5;"><strong>Rating: '.$rating.'</strong></font>
															
														</td>
														<td  align="right">
															<form method="post" action="search.php?id='.$place_id.'">
															  <font class="rate_this" style="background-attachment:fixed;">Rate this: </font>
															  <input type="button" value="1" name="r1"  id="r1" class="rate_number" onMouseOver="change_color_of_rating(this);" onMouseOut="clear_rating_color();" style="background-attachment:fixed;vertical-align:middle;"  onClick="rate(this);" >
															  <input type="button" value="2" name="r2" id="r2"  class="rate_number" onMouseOver="change_color_of_rating(this);" onMouseOut="clear_rating_color();" style="background-attachment:fixed;vertical-align:middle;" onClick="rate(this);">
															  <input type="button" value="3" name="r3" id="r3"  class="rate_number" onMouseOver="change_color_of_rating(this);" onMouseOut="clear_rating_color();" style="background-attachment:fixed;vertical-align:middle;" onClick="rate(this);"> 
															  <input type="button" value="4" name="r4" id="r4"  class="rate_number" onMouseOver="change_color_of_rating(this);" onMouseOut="clear_rating_color();" style="background-attachment:fixed;vertical-align:middle;" onClick="rate(this);">
															  <input type="button" value="5" name="r5" id="r5"  class="rate_number" onMouseOver="change_color_of_rating(this);" onMouseOut="clear_rating_color();" style="background-attachment:fixed;;vertical-align:middle;" onClick="rate(this);">
															</form>
														</td>
