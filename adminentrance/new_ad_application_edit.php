<html>
	<?php
        ...
        if(isset($_POST['poster_name'])||isset($_POST['poster_email_id'])||isset($_POST['poster_contact_number'])||isset($_POST['place_name'])||isset($_POST['place_address'])||isset($_POST['ad_title'])||isset($_POST['ad_content']))
        {
            ...
            $query="UPDATE `temp_ads` SET `POSTER_NAME`='$poster_name',`POSTER_EMAIL_ID`='$poster_email_id',`POSTER_CONTACT_NUMBER`='$poster_contact_number',`PLACE_NAME`='$place_name',`PLACE_ADDRESS`='$place_address',`AD_TITLE`='$ad_title',`AD_CONTENT`='$ad_content' WHERE `AD_ID`=$id";
    ...
    <table cellpadding="3" cellspacing="0" border="0" width="98%" align="center">
        ...
        <tr>
            <td>
            	<form action="new_ad_application_edit.php?id=<?php echo $id;?>" method="post">
                    <table border="0" cellpadding="5" cellspacing="0" class="edit_box" width="100%">
                        <tr>
                            <td class="title" colspan="2">
                                Edit New Ad Application
                            </td>
                        </tr>
                        <tr>
                            <td>
