    ...
    <table class="email_form" align="center">
        ...
        <tr>
            <td>
                        ...
                        <td align="center">
                            <font color="#FF0000" face="Trebuchet MS, Arial, Helvetica, sans-serif" class="suggestion_notice">
                                <?php
                                    ...
                                    if(isset($_POST['to'])||isset($_POST['subject'])||isset($_POST['message'])||isset($_POST['number']))
                                    {
                                        
                                        if(!empty($_POST['to'])&&!empty($_POST['subject'])&&!empty($_POST['message'])&&!empty($_POST['number']))
                                        {
                                            if($_POST['number']==$generated_captcha)
                                            {
                                                ...
                                                {
                                                    echo ' <font class="suggestion_ok_notice">&nbsp;&nbsp;  Email has been sent successfully.&nbsp;&nbsp;  </font>';
                                                }
                                                else
                                                    echo '&nbsp;&nbsp;  Sorry! Problem occured in sending the email.&nbsp;&nbsp;  ';	
                                            }
                                            else
                                                echo '&nbsp;&nbsp;  The number you entered didn\'t match.&nbsp;&nbsp;  ';
                                        }
                                        else
                ...
                <form action="email_anyone.php" method="post">
                    <table cellpadding="5" cellspacing="0" class="suggestion_box_form" align="center" width="100%">
                        ...
                        <tr  valign="top" >
                            <td colspan="2" align="center" style=" border:10px thick #000;padding-right:3%;" >
                                <font class="form_title">Email Anyone</font><br><br>
                            </td>
                        </tr>
                        <tr  valign="top">
                        ...
                        <tr >
                            ...
                            <td>
                                : <input type="text" name="to" class="text_box" maxlength="200"><font color="#FF0000"> * </font>
                            </td>
                        </tr>
                        <tr >
                            <td width="20%">
