    ...
    <div class="navbar-container">
      ...
      -->
          <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.php?#home" style="font-size:30px; font-weight:bolder;">Glog</a>
            </div>
      <div id="nav-collapse" class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a title="Home page" class="scroll brand-1" href="index.php">Home</a></li>
              ...
              <li><a><span class="input-group-btn"  style="padding-top:2px;">
                                                            ...
                                                            <div class="col-md-12">
                                                              <div class="  btn-container loaded">
                                                                <div class="btn-container">
                                                                  <center><img class="figurette lazy " src="assets/img/place_images/'.$image_name .'" data-original="assets/img/place_images/'.$image_name .'" alt="Image not available" style="display: inline; height:150px; width:400px;font-size:14px;"></center>
