<?php
    ...
    $no_of_characters_in_each_suggestion_row=45;
    ...
    <nav class="navbar navbar-inverse " role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top" style="font-size:40px; font-weight:bolder;">Glog</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse pull-right">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#contact">Suggest A Place</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 centered" style="margin-top:140px;">
                        ...
                        <!-- Suggestions-->
                            <?php
                                ...
                                {   
                                    ...
                                    if(($name==NULL)||($name=="Place (eg- GP Sweets)"))
                                        $name='%';
                                    if(($for==NULL)||($for=="For (eg- Pizza)"))
                                        $for='%';
                                    if(($area==NULL)||($area=="In Area (eg- Bank Colony)"))
                                        $area='%';  
                                            ...
                                            echo '<tr >
                                                <td  class="suggestion_text_box" style="margin-top:0 0 0 0">
                                                    <table cellpadding="1" cellspacing="0" border="0" width="100%" class="suggestion_text">
                                                          <tr valign="top">
                                                          <td colspan="2" ><a href="search.php?id='.$place_id.'" style="text-decoration:none;" class="place_names">'.$name.'</a></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan=2 align="right" ><a href="search.php?id='.$place_id.'" class="view_details"><font>View details...</font></a></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                              </tr>';   
                                          ...
                                          <table align="center" width="100%" style="margin:0 0 0 0;">
                                              ...
                                              <tr>
                                                <td  class="detailed_text_box" style="margin-top:10px;">
                                                    <table cellpadding="1" cellspacing="0" border="1" width="100%" class="suggestion_detail_text_table">
                                                        <tr valign="top" >
                                                        ...
                                                        <tr>
                                                            <td colspan=2 class="about_the_place">About this place:</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td colspan=2 class="full_description"><br>'.$description.'<br><br></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2"  class="contribute_in_glog" style="font-size:16px;" align="right">
                                                                <form action="search.php" method="post">
                                                                    <font style=" font-size:12px;">Know about some places? Contribute in Glog.</font>
                                                                     <input type="submit" value="Suggest A Place" name="suggest_a_place" class="next_and_previous_button" style="padding:2 10 5 10;">
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    </table>
